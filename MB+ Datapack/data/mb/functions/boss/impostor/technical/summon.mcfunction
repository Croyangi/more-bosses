...
title @a title [{"text":"\ub052","font":"mb:boss","color":"white","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
...
execute as @a[scores={MB.difficulty=0}] run bossbar set mb:impostor name {"text":"\ub050","font":"mb:boss"}
execute as @a[scores={MB.difficulty=1}] run bossbar set mb:impostor max 1000
execute as @a[scores={MB.difficulty=1}] run bossbar set mb:impostor name {"text":"\ub051","font":"mb:boss"}
bossbar set mb:impostor visible true

execute at @s[scores={MB.difficulty=0}] run summon husk ~ ~ ~ {PersistenceRequired:1b,Silent:1b,DeathLootTable:"mb:entities/impostor/death",Health:500f,IsBaby:0b,CanBreakDoors:1b,Tags:["mb.impostor","mb.impostor.cleanup"],CustomName:'{"text":"Impostor","color":"red"}',ArmorItems:[{},{},{},{id:"minecraft:leather_horse_armor",Count:1b,tag:{CustomModelData:500000}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:19999980,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:500},{Name:"generic.follow_range",Base:100},{Name:"generic.knockback_resistance",Base:0.5},{Name:"generic.movement_speed",Base:0.5},{Name:"generic.attack_damage",Base:20}]}
execute at @s[scores={MB.difficulty=1}] run summon husk ~ ~ ~ {PersistenceRequired:1b,Silent:1b,DeathLootTable:"mb:entities/impostor/death",Health:1000f,IsBaby:0b,CanBreakDoors:1b,Tags:["mb.impostor","mb.impostor.cleanup"],CustomName:'{"text":"Impostor","color":"red"}',ArmorItems:[{},{},{},{id:"minecraft:leather_horse_armor",Count:1b,tag:{CustomModelData:500000}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:19999980,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.follow_range",Base:100},{Name:"generic.knockback_resistance",Base:0.5},{Name:"generic.movement_speed",Base:0.5},{Name:"generic.attack_damage",Base:40}]}

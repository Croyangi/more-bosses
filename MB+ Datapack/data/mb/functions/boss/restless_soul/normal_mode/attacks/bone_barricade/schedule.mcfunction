...
# Sets blocks
execute at @e[type=minecraft:wandering_trader,tag=mb.restless_soul] if entity @a[distance=..10,gamemode=!creative,gamemode=!spectator] run summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["mb.restless_soul.cleanup","mb.bone_barricade.marker"],DisabledSlots:41449109}
execute at @e[type=minecraft:wandering_trader,tag=mb.restless_soul] if entity @a[distance=..10,gamemode=!creative,gamemode=!spectator] run summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["mb.restless_soul.cleanup","mb.bone_barricade.marker"],DisabledSlots:41449109}
execute at @e[type=minecraft:wandering_trader,tag=mb.restless_soul] if entity @a[distance=..10,gamemode=!creative,gamemode=!spectator] run summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["mb.restless_soul.cleanup","mb.bone_barricade.marker"],DisabledSlots:41449109}
execute at @e[type=minecraft:wandering_trader,tag=mb.restless_soul] if entity @a[distance=..10,gamemode=!creative,gamemode=!spectator] run summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["mb.restless_soul.cleanup","mb.bone_barricade.marker"],DisabledSlots:41449109}
execute at @e[type=minecraft:wandering_trader,tag=mb.restless_soul] if entity @a[distance=..10,gamemode=!creative,gamemode=!spectator] run summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["mb.restless_soul.cleanup","mb.bone_barricade.marker"],DisabledSlots:41449109}

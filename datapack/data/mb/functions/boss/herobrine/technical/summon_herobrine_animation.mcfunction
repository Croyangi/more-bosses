...
execute if entity @a[scores={MB.difficulty=0},sort=arbitrary] run function mb:boss/herobrine/normal_mode/summon_schedule
execute if entity @a[scores={MB.difficulty=1},sort=arbitrary] run function mb:boss/herobrine/master_mode/summon_schedule
execute if entity @a[scores={mb.speedrunTimer=1},sort=arbitrary] run function mb:boss/technical/speedrun_timer/schedule

advancement grant @a[sort=arbitrary] only mb:boss/herobrine/summon
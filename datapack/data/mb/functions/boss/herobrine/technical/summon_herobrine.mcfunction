...
execute as @s[scores={MB.difficulty=0}] run function mb:boss/herobrine/normal_mode/summon_schedule
execute as @s[scores={MB.difficulty=1}] run function mb:boss/herobrine/master_mode/summon_schedule
function mb:boss/technical/speedrun_timer/schedule

advancement grant @s only mb:boss/herobrine/summon
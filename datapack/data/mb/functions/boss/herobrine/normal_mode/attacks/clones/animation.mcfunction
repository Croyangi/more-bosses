############################################################
# Description: Execute as Herobrine clone
############################################################
...
item replace entity @s weapon.mainhand with leather_horse_armor{CustomModelData:400000}
item replace entity @s[predicate=mb:moving] weapon.mainhand with leather_horse_armor{CustomModelData:400001}
item replace entity @s armor.head with leather_horse_armor{CustomModelData:400002}

...
# Honey Spill
schedule function mb:boss/queen_bee/master_mode/attacks/honey_spill/summon 1s append

# Stinger Rain
schedule function mb:boss/queen_bee/master_mode/attacks/stinger_rain/schedule 5s append

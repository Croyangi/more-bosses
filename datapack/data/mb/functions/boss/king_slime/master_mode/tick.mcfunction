...
# Second phase
execute if score king_slime.health mb.dummy1 matches 1..149 run advancement grant @a only mb:technical/boss/king_slime/master_second_phase

schedule function mb:boss/king_slime/master_mode/tick 1t append
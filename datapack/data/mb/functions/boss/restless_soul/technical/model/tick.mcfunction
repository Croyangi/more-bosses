...
item replace entity @s[tag=!mb.restless_soul.animated] weapon.mainhand with leather_horse_armor{CustomModelData:133000}
item replace entity @s[tag=!mb.restless_soul.animated,predicate=mb:moving] weapon.mainhand with leather_horse_armor{CustomModelData:133001}
item replace entity @s[tag=mb.restless_soul.animated] weapon.mainhand with leather_horse_armor{CustomModelData:133003}

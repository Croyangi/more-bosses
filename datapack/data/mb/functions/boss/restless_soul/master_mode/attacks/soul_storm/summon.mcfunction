...
execute at @e[type=wandering_trader,tag=mb.restless_soul] if entity @a[distance=..30,gamemode=!creative,gamemode=!spectator] run playsound mb:entity.soul_storm.spawn master @a[distance=..16]
...
schedule function mb:boss/restless_soul/master_mode/attacks/soul_storm/summon 20s
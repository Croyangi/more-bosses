...
execute at @e[type=wandering_trader,tag=mb.restless_soul] at @p[distance=..10,gamemode=!creative,gamemode=!spectator] run spreadplayers ~ ~ 1.5 3 false @e[type=armor_stand,tag=mb.bone_barricade.marker]

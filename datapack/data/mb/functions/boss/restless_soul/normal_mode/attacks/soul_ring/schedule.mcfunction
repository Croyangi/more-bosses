...
function mb:boss/restless_soul/normal_mode/attacks/soul_ring/tick
schedule function mb:boss/restless_soul/normal_mode/attacks/soul_ring/schedule_clear 4s append
schedule function mb:boss/restless_soul/normal_mode/attacks/soul_ring/end 4.5s append
...
schedule function mb:boss/restless_soul/normal_mode/attacks/soul_ring/schedule 15s append
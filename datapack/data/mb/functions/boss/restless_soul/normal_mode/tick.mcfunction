...
# Soul Storm
execute as @e[type=armor_stand,tag=mb.soul_storm] at @s run function mb:boss/restless_soul/normal_mode/attacks/soul_storm/tick

# Second phase
execute if score restless_soul.health mb.dummy1 matches 1..199 run advancement grant @a only mb:technical/boss/restless_soul/normal_second_phase

schedule function mb:boss/restless_soul/normal_mode/tick 1t append
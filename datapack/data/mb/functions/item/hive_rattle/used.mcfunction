...
item replace entity @s[scores={hive_rattle.tog=0}] weapon.mainhand with carrot_on_a_stick{display:{Name:'{"translate":"item.mb.hive_rattle","color":"yellow","italic":false}',Lore:['{"translate":"item.mb.tag.summon","color":"dark_gray","italic":true}','{"text":" "}','{"translate":"item.mb.hive_rattle.lore","color":"dark_green","italic":false}','{"translate":"item.mb.summon.empty_tag","color":"white","italic":false}','{"translate":"pack.mb","color":"dark_purple","italic":true}']},CustomModelData:133026} 1

# Toggle
scoreboard players add @s hive_rattle.tog 1
item replace entity @s[scores={hive_rattle.tog=2..}] weapon.mainhand with carrot_on_a_stick{display:{Name:'{"translate":"item.mb.hive_rattle","color":"yellow","italic":false}',Lore:['{"translate":"item.mb.tag.summon","color":"dark_gray","italic":true}','{"text":" "}','{"translate":"item.mb.hive_rattle.lore","color":"dark_green","italic":false}','{"translate":"item.mb.summon.full_tag","color":"white","italic":false}','{"translate":"pack.mb","color":"dark_purple","italic":true}']},CustomModelData:133025} 1
execute as @s[scores={hive_rattle.tog=2..}] run scoreboard players set @s hive_rattle.tog 0

function mb:item/hive_rattle/loop
...
# Rattled Hive
execute at @e[predicate=mb:items/bruce/this] if entity @e[distance=..1,limit=1,sort=nearest,type=item,nbt={Item:{id:"minecraft:honey_bottle",Count:1b}}] run function mb:item/rattled_hive/dropcraft

...
summon slime ~ ~ ~ {Silent:1b,Invulnerable:1b,Team:"MB.pets",DeathLootTable:"null",PersistenceRequired:1b,Tags:["mb.royal_jello.prince_slime"],ActiveEffects:[{Id:11b,Amplifier:4b,Duration:19999980,ShowParticles:0b}]}

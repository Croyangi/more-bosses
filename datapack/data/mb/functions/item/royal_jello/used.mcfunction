...
execute as @e[type=wandering_trader,tag=mb.royal_jello.prince_slime] if score @s royal_jello.UUID = .search royal_jello.UUID run tp @s ~ -1000 ~
execute as @e[type=wandering_trader,tag=mb.royal_jello.prince_slime] if score @s royal_jello.UUID = .search royal_jello.UUID run kill @s
